					...
					<div className='mb-5 sm:mb-8'>
						...
						<div className='mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:border-blue-800'>
							...
							<div className='space-y-1 text-xs text-blue-700 dark:text-blue-400'>
								<div>
									<strong>Admin:</strong> admin@electrolandgh.com / admin123
								</div>
								<div>
									<strong>Manager:</strong> manager@electrolandgh.com / manager123
								</div>
								<div>
									<strong>User:</strong> user@electrolandgh.com / user123
								</div>
							</div>
						</div>
					</div>
